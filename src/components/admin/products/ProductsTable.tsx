...
export function ProductsTable({ 
  ...
  const canDelete = (productId: number) => !productsWithTransactions.includes(String(productId));
              ...
              <tbody>
                {filteredProducts?.map(product => (
                  <tr key={product.productId} className="border-b hover:bg-gray-50">
                    ...
                    <td className="p-2">₦{product?.costPrice?.toLocaleString()}</td>
                    <td className="p-2">
                      <span className={getStockColor(product.currentStock, product.minimumStockLevel)}>
                          ...
                          <AlertDialog>
                            ...
                            <AlertDialogContent>
                              ...
                              <AlertDialogFooter>
                                ...
                                <AlertDialogAction onClick={() => onDeleteProduct(product.productId)}>
                                  Delete
                                </AlertDialogAction>
                              </AlertDialogFooter>
                            </AlertDialogContent>
